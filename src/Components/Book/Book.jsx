  ...
  return (
    <Link to={`/book/${id}`}>
      <div className="card card-compact bg-base-100 shadow-lg">
        <div className="bg-purple-100 w-70 h-70 border rounded shadow-lg m-4 ">
        ...
        <div className="card-body font-bold text-base">
        ...
        <div className="flex justify-between p-4 font-sm text-base ">
          <p>{category}</p>
